    ...
    <div class="connection-type two">
      <div class="connection-type two">
        ...
        <select @change="onChange('type', parseInt($event.target.value))" v-model="localType">
          <option :value="connectionTypes.IRZ_ATM">Через модем</option>
          <option :value="connectionTypes.IRZ_ATM_SIP">Через VoIP</option>
          <option :value="connectionTypes.IRZ_ATM_WithoutCall">Без вызова</option>
        </select>
      </div>
      <div v-if="group.type === connectionTypes.IRZ_ATM" class="connection-type two">
        <div class="connection-type two">
          <label>Порт:</label>
      ...
      <div v-else-if="group.type === connectionTypes.IRZ_ATM_SIP" class="connection-type two">
