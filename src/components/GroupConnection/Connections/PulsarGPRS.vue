<template>
  <div class="connection-type">
    <div class="connection-type two">
      ...
      <input @input="onChange('adapter', $event.target.value)" v-model="localAdapter" type="text" :class="{ 'validation-error': localError.adapter }" :title="localError.adapter" maxlength="29" style="width: 150px" />
